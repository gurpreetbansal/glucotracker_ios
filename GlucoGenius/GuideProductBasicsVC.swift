...
class GuideProductBasicsVC: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.title = productBasics_title
        ...
        backBtn.addTarget(self, action: #selector(GuideProductBasicsVC.backBtnAction), for: UIControl.Event.touchUpInside)
